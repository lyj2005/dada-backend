package com.lyj.dada.service.impl;
...
import com.lyj.dada.mapper.UserMapper;
import com.lyj.dada.model.dto.user.UserQueryRequest;
import com.lyj.dada.model.entity.User;
import com.lyj.dada.model.enums.UserRoleEnum;
import com.lyj.dada.model.vo.LoginUserVO;
import com.lyj.dada.model.vo.UserVO;
import com.lyj.dada.service.UserService;
import com.lyj.dada.utils.SqlUtils;
...
import static com.lyj.dada.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if (userAccount.length() < 4) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "账号错误，账号长度小于4");
        }
